...
- 발표 자료: [발표 자료 보기](https://drive.google.com/file/d/1PG9CNtViPHcyvscSNQcIhtH1Udk20sZo/view?usp=drive_link)
...
### 오재건
- 댓글, 좋아요 CRUD 구현
- QueryDsl 라이브럴리 기반 동적 쿼리 + 커서 페이지네이션 작성
- 복합 unique 키 설정을 이용한 동시 등록 방지 처리
- 댓글, 좋아요 엔티티의 연관 리소스 삭제에 대한 캐스케이드 설정
- 댓글, 좋아요 swagger 문서 및 API 명세 작성
- 댓글, 좋아요 기능관련 각 계층 테스트 작성
- 최종 발표 담당
